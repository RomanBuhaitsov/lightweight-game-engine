...
LGE_PhysicsComponent::LGE_PhysicsComponent(b2Body* body, std::function<bool(LGE_Entity*)> touch) : LGE_Component(LGE_ComponentType::CT_PHYSICS), body(body), touch(touch)
{
}

LGE_PhysicsComponent::LGE_PhysicsComponent(b2Body* body) : LGE_PhysicsComponent(body, nullptr)
{

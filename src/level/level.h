...
public:
	Camera(int level_width, int level_height, int screen_width, int screen_height, int delay);
	Camera(int level_width, int level_height, int screen_width, int screen_height, int delay, int step_x, int step_y);
